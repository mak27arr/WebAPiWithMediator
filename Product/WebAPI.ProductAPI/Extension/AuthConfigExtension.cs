...
namespace WebAPI.ProductAPI.Extension
{
    internal static class AuthGoogleConfigExtension
    {
        ...
        internal static IServiceCollection AddAuthConfig(this IServiceCollection services, IConfiguration configuration)
        {
        ...
        internal static IApplicationBuilder ConfigureAuthentication(this IApplicationBuilder app, IConfiguration configuration)
        {
            if (IsAuthAvailable(configuration))
            {
